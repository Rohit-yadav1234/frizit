...
const Qutation2 = ({ partfreight }) => {
  ...
  }, [pickupLocation, dropLocation, selected, startDate, endDate]);

  return (
    <div className="max-w-[1050px] bg-white rounded-lg  xl:max-w-[1320px] w-full py-[30px] px-3 md:px-[30px] flex flex-col gap-[10px] font-poppins mx-auto">
      ...
      <div className="flex max-md:flex-col items-center gap-8 md:gap-0 pt-[27px] border-t-2 border-[#DEE2E6]">
            ...
            {[1, 2].map((id) => (
              ...
              >
                ...
                <p
                  ...
                  ${selected === id ? "text-white" : "text-[#7C7C7C]"}`}
                >
                  {id === 1 ? "Chiller" : "Frozen"}
                </p>
                <p
        ...
        <div className="!pr-0 quotationmaindivstyle">
          <p className=" text-black flex justify-between gap-2 font-bold leading-[110%]">
            <span>
              Start date<span className="text-[#F22]">*</span>
            </span>
            <span>
              End date<span className="text-[#F22]">*</span>
            </span>
          </p>
          <div className="relative flex gap-4">
            {/* Start Date Picker */}
            <div className="relative flex w-full gap-3 xl:gap-[5px] py-[13px] px-2 xl:px-5 items-center quotationsdivstyle">
              <div
              ...
              >
                <Image
                  ...
                  alt="calendar"
                />
                <p className="text-[#7B8A93] text-sm font-medium whitespace-nowrap leading-normal">
                  {startDate ? startDate.toLocaleDateString() : "Start*"}
                </p>
              </div>
              {showStartCalendar && (
                <div className="absolute top-[calc(100%+5px)] left-0 z-20 bg-white shadow-lg rounded">
                  <DatePicker
                    selected={startDate}
            ...
            <div className="relative flex w-full gap-3 xl:gap-[5px] py-[13px] px-2 xl:px-5 items-center quotationsdivstyle">
              ...
              {showEndCalendar && (
                <div className="absolute top-[calc(100%+5px)] -left-28 z-20 bg-white shadow-lg rounded">
                  <DatePicker
                    selected={endDate}
